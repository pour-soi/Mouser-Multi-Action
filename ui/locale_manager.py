...
_TRANSLATIONS = {
    "en": {
        ...
        "mouse.connect_mouse_desc": "Mouser Multi-Action will detect the active device, unlock button mapping, and enable the correct layout mode as soon as the mouse is available.",
        ...
        "mouse.add_app_dialog.desc": "Choose an app. Mouser Multi-Action will switch to this profile when that app is focused.",
        ...
        "scroll.appearance_desc": "Choose whether Mouser Multi-Action follows the system, stays light, or stays dark.",
        "scroll.system": "System",
        "scroll.light": "Light",
        "scroll.dark": "Dark",
        "scroll.startup": "Startup",
        "scroll.startup_desc": "Start Mouser Multi-Action at login on supported desktop platforms, and choose whether the settings window opens on launch or the app stays in the system tray.",
        "scroll.start_at_login": "Start at login",
        "scroll.start_minimized": "Start minimized",
        "scroll.screenshots": "Screenshots",
        "scroll.screenshots_desc": "Choose where Mouser Multi-Action saves screenshot file actions. Clipboard actions are unaffected.",
        ...
        "scroll.check_for_updates_desc": "Notify when a newer Mouser Multi-Action release is available. Downloads and installation stay manual.",
        "scroll.update_idle": "Mouser Multi-Action can check for new releases.",
        "scroll.update_available": "Mouser Multi-Action %1 is available.",
        ...
        "scroll.update_ready": "Ready to install after Mouser Multi-Action quits.",
        ...
        "scroll.update_manual": "A new Mouser Multi-Action release is available. Download it from the release page and install manually.",
        "scroll.update_manual_windows": "A new Mouser Multi-Action release is available. Download it from the release page and install manually on Windows.",
        "scroll.update_manual_macos": "A new Mouser Multi-Action release is available. Download it from the release page and install manually on macOS.",
        "scroll.update_manual_linux": "A new Mouser Multi-Action release is available. Download it from the release page and install manually on Linux.",
        ...
        "scroll.update_error_network_error": "Mouser Multi-Action could not reach the update service. Try again later.",
        ...
        "scroll.update_error_permission_denied": "Mouser Multi-Action does not have permission to prepare the update.",
        "scroll.update_error_file_error": "Mouser Multi-Action could not write the update files.",
        ...
        "scroll.update_error_older_build": "Mouser Multi-Action rejected an older update.",
        ...
        "key_capture.error.unsupported_key": "Choose a different key. %1 isn't available in Mouser Multi-Action.",
        ...
        "tray.update_available": "Mouser Multi-Action {version} is available. Open the release page to download it.",
        "tray.quit": "Quit Mouser Multi-Action",
        "tray.tray_message": "Mouser Multi-Action is running in the system tray. Click the icon to open settings.",

        # Accessibility dialog (macOS)
        "accessibility.title": "Accessibility Permission Required",
        "accessibility.text": (
            "Mouser Multi-Action needs Accessibility permission to intercept "
            "mouse button events.\n\n"
            "macOS should have opened the System Settings prompt.\n"
            "Please grant permission, then restart Mouser Multi-Action."
        ),
        ...
        # About dialog
        "about.title": "Mouser Multi-Action",
