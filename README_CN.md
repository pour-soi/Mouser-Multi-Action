...
<p>
  <a href="https://github.com/pour-soi/PourInput/releases/download/v1.3.2/PourInput-v1.3.2-Windows.zip">
    <img src="https://img.shields.io/badge/%E4%B8%8B%E8%BD%BD_Windows_%E7%89%88-v1.3.2-0078D4?style=for-the-badge&logo=windows11&logoColor=white" alt="下载 Windows 版">
  </a>
  <a href="https://github.com/pour-soi/PourInput/releases/tag/v1.3.2">
    <img src="https://img.shields.io/badge/%E7%89%88%E6%9C%AC%E8%AF%B4%E6%98%8E-v1.3.2-555555?style=for-the-badge" alt="版本说明">
  </a>
</p>
...
[**PourInput-v1.3.2-Windows.zip**](https://github.com/pour-soi/PourInput/releases/download/v1.3.2/PourInput-v1.3.2-Windows.zip) · [版本说明](https://github.com/pour-soi/PourInput/releases/tag/v1.3.2)

1. 下载 ZIP 压缩包。
2. 将压缩包解压到普通文件夹。
3. 运行 `PourInput-v1.3.2/PourInput.exe`。
...
- `PourInput-v1.3.2-Windows.zip`
- `PourInput-v1.3.2-Windows.zip.sha256`
- `pourinput-v1.3.2-update.json`
